...
\date{\vfill \hrule \vspace*{2mm}
  \begin{tabular}{l}
      ...
      Sevilla, 12 de septiembre de 2016
...
El libro consta de 7 capítulos correspondientes a los 7 cursos en los que
...
Además contiene dos apéndices. Uno con el método de Polya de resolución de problemas
(sobre el que se hace énfasis durante todo el curso) y el otro con un resumen
de las funciones de Haskell de uso más frecuente. 

En resumen, el libro contiene tiene 155 exámenes con un total de 1.012
ejercicios.
